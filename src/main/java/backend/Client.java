...
public class Client {
    ...
    public void closeEverything( BufferedWriter bufferedWriter, BufferedReader bufferedReader, Socket socket) {
        try {
            if (bufferedWriter == null || bufferedWriter != null ) bufferedWriter.close();
            if (bufferedReader == null || bufferedReader != null ) bufferedReader.close();
            if (socket == null || socket != null ) socket.close();
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public static void main(String[] args) throws IOException{
        ...
        while (true) {
            if( resp.toLowerCase().equalsIgnoreCase("sign in")) {
                ...
                */
                ...
                authorization.Start();
                break;
            }else if(resp.toLowerCase().equalsIgnoreCase("sign up")){
